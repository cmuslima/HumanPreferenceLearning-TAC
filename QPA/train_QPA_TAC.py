...
config_path = os.path.join(parent_dir, 'config/train_QPA.yaml')
sys.path.append(parent_dir)
from replay_buffer import ReplayBuffer
from reward_model_QPA_TAC import RewardModel
...
def main(cfg):
    ...
    wandb.init(
        ...
        name=f'QPA_soft_tac_{cfg.env}_{cfg.max_feedback}_{cfg.experiment}_{cfg.seed}',
        entity="musliman",
        mode='online',
    )
    workspace.run()
