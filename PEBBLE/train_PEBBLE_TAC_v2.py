...
config_path = os.path.join(parent_dir, 'config/train_PEBBLE.yaml')
sys.path.append(parent_dir)
from replay_buffer import ReplayBuffer
from reward_model_PEBBLE_TAC import RewardModel
        ...
        if self.labeled_feedback > 0:
            ...
            for epoch in range(self.cfg.reward_update):
                if self.cfg.label_margin > 0 or self.cfg.teacher_eps_equal > 0:
                    ...
                    train_acc, reward_loss  = self.reward_model.train_reward_tac_v2()
...
def main(cfg):
    ...
    wandb.init(
        ...
        name=f'PEBBLE_TAC_{cfg.env}_{cfg.max_feedback}_{cfg.seed}',
        entity="musliman",
        mode='online',
    )
    workspace.run()
